...
import HistoryTransaction from '../component/Home/transaction/history/HistoryTransaction';
    ...
    return (
        <Tab.Navigator activeColor="yellow">
            ...
            <Tab.Screen
                ...
                options={{
                    tabBarLabel: 'History',
                    tabBarIcon: ({ color }) => <Icons size={25} name={'ios-list-box'} color={color} />
                }}
            />
            <Tab.Screen
                name='Profile'
