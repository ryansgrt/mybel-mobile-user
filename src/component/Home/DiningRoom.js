...
import MejaMakan from '../../picture/mejamakan.jpeg';
import KursiMakan from '../../picture/kursiMakan.jpg';
        ...
        <View>
            <Animatable.View animation='zoomInDown'>
                <View style={{ marginLeft: 15, marginTop: 80 }}>
                    <TouchableHighlight onPress={() => navigation.navigate('MejaMakan')}>
                        <ImageBackground source={MejaMakan} style={styles.photo}>
                            <View style={styles.blurImage}>
                                <Text style={styles.title}> Dining Table</Text>
                            </View>
                        </ImageBackground>
                    </TouchableHighlight>
                </View>
                ...
                <View style={{ marginLeft: 15, marginTop: 40 }} >
                    <TouchableHighlight onPress={() => navigation.navigate('KursiMakan')}>
                        <ImageBackground source={KursiMakan} style={styles.photo}>
                            <View style={styles.blurImage}>
                                <Text style={styles.title}> Dining Chair</Text>
                            </View>
                        </ImageBackground>
                    </TouchableHighlight>
                </View>
