...
import kursi from '../../picture/kursiTamu.jpg';
import Sofa from '../../picture/sofa.jpg';
        ...
        <View>
            <Animatable.View animation='zoomInDown'>
                <View style={{ marginLeft: 15, marginTop: 80 }}>
                    <TouchableHighlight onPress={() => navigation.navigate('Chair')}>
                        <ImageBackground source={kursi} style={styles.photo}>
                ...
                <View style={{ marginLeft: 15, marginTop: 40 }} >
                    <TouchableHighlight onPress={() => navigation.navigate('Sofa')}>
                        <ImageBackground source={Sofa} style={styles.photo}>
                            <View style={styles.blurImage}>
