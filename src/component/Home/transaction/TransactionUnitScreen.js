...
import { View, ToastAndroid, Text, TextInput, TouchableOpacity, StyleSheet, Modal } from 'react-native';
...
import * as Serv from '../../Profile/services/UserService'
const TransactionUnitScreen = props => {
    ...
    const product = unit.id;
    const totalPrices = unit.price * value.quantity;
...
export default TransactionUnitScreen
